...
class Document(_object):
    ...
    def _dropOutline(self, *args):
        """_dropOutline(self, ol)"""
        return _fitz.Document__dropOutline(self, *args)
    ...
    def embeddedFileDel(self, *args):
        """Delete embedded file by name."""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document_embeddedFileDel(self, *args)
    ...
    def embeddedFileAdd(self, *args):
        """Add new file from buffer."""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document_embeddedFileAdd(self, *args)
    ...
    def _getMetadata(self, *args):
        """_getMetadata(self, key) -> char *"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__getMetadata(self, *args)
    ...
    def authenticate(self, *args):
        ...
        val = _fitz.Document_authenticate(self, *args)
    ...
    def save(self, *args):
        ...
        return _fitz.Document_save(self, *args)
    ...
    def insertPDF(self, *args):
        ...
        val = _fitz.Document_insertPDF(self, *args)
        if val == 0:
            self._reset_page_refs()
            if links:
    ...
    def deletePage(self, *args):
        ...
        val = _fitz.Document_deletePage(self, *args)
        if val == 0: self._reset_page_refs()

        return val

    def deletePageRange(self, *args):
        """Delete pages 'from' to 'to'."""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        val = _fitz.Document_deletePageRange(self, *args)
        if val == 0: self._reset_page_refs()
    ...
    def copyPage(self, *args):
        ...
        val = _fitz.Document_copyPage(self, *args)
        if val == 0: self._reset_page_refs()
    ...
    def insertPage(self, *args):
        ...
        val = _fitz.Document_insertPage(self, *args)
        if val < 0: return val
        self._reset_page_refs()
    ...
    def movePage(self, *args):
        """Move page in front of 'to'."""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        val = _fitz.Document_movePage(self, *args)
        if val == 0: self._reset_page_refs()
    ...
    def select(self, *args):
        ...
        val = _fitz.Document_select(self, *args)
        if val == 0:
            self._reset_page_refs()
            self.initData()
    ...
    def _getPageObjNumber(self, *args):
        """_getPageObjNumber(self, pno) -> PyObject *"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__getPageObjNumber(self, *args)

    def getPageImageList(self, *args):
        """List images used on a page."""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document_getPageImageList(self, *args)

    def getPageFontList(self, *args):
        """List fonts used on a page."""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document_getPageFontList(self, *args)
    ...
    def _getPageRectText(self, *args):
        """_getPageRectText(self, pno, rect) -> char const *"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__getPageRectText(self, *args)
    ...
    def _getObjectString(self, *args):
        """_getObjectString(self, xref) -> char const *"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__getObjectString(self, *args)

    _getXrefString = _getObjectString
    def _getXrefStream(self, *args):
        """_getXrefStream(self, xref) -> PyObject *"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__getXrefStream(self, *args)

    def _updateObject(self, *args):
        """_updateObject(self, xref, text, page=None) -> int"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__updateObject(self, *args)

    def _updateStream(self, *args):
        """_updateStream(self, xref, stream) -> int"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__updateStream(self, *args)

    def _setMetadata(self, *args):
        """_setMetadata(self, text) -> int"""
        if self.isClosed:
            raise RuntimeError("operation illegal for closed doc")

        return _fitz.Document__setMetadata(self, *args)
...
class Page(_object):
    ...
    def run(self, *args):
        ...
        return _fitz.Page_run(self, *args)
    ...
    def deleteLink(self, *args):
        ...
        val = _fitz.Page_deleteLink(self, *args)
    ...
    def deleteAnnot(self, *args):
        """Delete annot if PDF and return next one"""
        CheckParent(self)

        val = _fitz.Page_deleteAnnot(self, *args)
        if val:
            val.thisown = True
            val.parent = weakref.proxy(self) # owning page object
    ...
    def setRotation(self, *args):
        ...
        return _fitz.Page_setRotation(self, *args)

    def _addAnnot_FromString(self, *args):
        """_addAnnot_FromString(self, linklist) -> int"""
        CheckParent(self)

        return _fitz.Page__addAnnot_FromString(self, *args)
    ...
    def insertImage(self, *args):
        ...
        return _fitz.Page_insertImage(self, *args)
    ...
    def _getRectText(self, *args):
        """_getRectText(self, rect) -> char const *"""
        CheckParent(self)

        return _fitz.Page__getRectText(self, *args)
...
def _fz_transform_rect(*args):
  """_fz_transform_rect(rect, transform) -> Rect"""
  return _fitz._fz_transform_rect(*args)
class Rect(_object):
    ...
    if _newclass:x0 = _swig_property(_fitz.Rect_x0_get, _fitz.Rect_x0_set)
    __swig_setmethods__["y0"] = _fitz.Rect_y0_set
    __swig_getmethods__["y0"] = _fitz.Rect_y0_get
    if _newclass:y0 = _swig_property(_fitz.Rect_y0_get, _fitz.Rect_y0_set)
    __swig_setmethods__["x1"] = _fitz.Rect_x1_set
    __swig_getmethods__["x1"] = _fitz.Rect_x1_get
    if _newclass:x1 = _swig_property(_fitz.Rect_x1_get, _fitz.Rect_x1_set)
    __swig_setmethods__["y1"] = _fitz.Rect_y1_set
    __swig_getmethods__["y1"] = _fitz.Rect_y1_get
    if _newclass:y1 = _swig_property(_fitz.Rect_y1_get, _fitz.Rect_y1_set)
    ...
    def includePoint(self, *args):
        ...
        return _fitz.Rect_includePoint(self, *args)

    def intersect(self, *args):
        """Shrink to intersection with another 'Rect' r"""
        return _fitz.Rect_intersect(self, *args)

    def includeRect(self, *args):
        """Enlarge to include another 'Rect' r"""
        return _fitz.Rect_includeRect(self, *args)
...
class IRect(_object):
    ...
    if _newclass:x0 = _swig_property(_fitz.IRect_x0_get, _fitz.IRect_x0_set)
    __swig_setmethods__["y0"] = _fitz.IRect_y0_set
    __swig_getmethods__["y0"] = _fitz.IRect_y0_get
    if _newclass:y0 = _swig_property(_fitz.IRect_y0_get, _fitz.IRect_y0_set)
    __swig_setmethods__["x1"] = _fitz.IRect_x1_set
    __swig_getmethods__["x1"] = _fitz.IRect_x1_get
    if _newclass:x1 = _swig_property(_fitz.IRect_x1_get, _fitz.IRect_x1_set)
    __swig_setmethods__["y1"] = _fitz.IRect_y1_set
    __swig_getmethods__["y1"] = _fitz.IRect_y1_get
    if _newclass:y1 = _swig_property(_fitz.IRect_y1_get, _fitz.IRect_y1_set)
    ...
    def translate(self, *args):
        ...
        return _fitz.IRect_translate(self, *args)

    def intersect(self, *args):
        """intersect(self, ir) -> IRect"""
        return _fitz.IRect_intersect(self, *args)
...
class Pixmap(_object):
    ...
    __del__ = lambda self : None;
    def gammaWith(self, *args):
        """gammaWith(self, gamma)"""
        return _fitz.Pixmap_gammaWith(self, *args)

    def tintWith(self, *args):
        """tintWith(self, red, green, blue)"""
        if self.colorspace.n > 3:
            raise TypeError("CMYK colorspace cannot be tinted")

        return _fitz.Pixmap_tintWith(self, *args)
    ...
    def copyPixmap(self, *args):
        """copyPixmap(self, src, bbox)"""
        return _fitz.Pixmap_copyPixmap(self, *args)
    ...
    def getPNGData(self, *args):
        """getPNGData(self, savealpha=-1) -> PyObject *"""
        return _fitz.Pixmap_getPNGData(self, *args)

    def _writeIMG(self, filename, *args):
        ...
        return _fitz.Pixmap__writeIMG(self,filename, *args)
...
class Colorspace(_object):
    ...
    def __init__(self, *args):
        ...
        this = _fitz.new_Colorspace(*args)
        try: self.this.append(this)
        except: self.this = this
    @property
    def n(self):
...
def _fz_pre_scale(*args):
  """_fz_pre_scale(m, sx, sy) -> Matrix"""
  return _fitz._fz_pre_scale(*args)

def _fz_pre_shear(*args):
  """_fz_pre_shear(m, sx, sy) -> Matrix"""
  return _fitz._fz_pre_shear(*args)

def _fz_pre_rotate(*args):
  """_fz_pre_rotate(m, degree) -> Matrix"""
  return _fitz._fz_pre_rotate(*args)
class Matrix(_object):
    ...
    if _newclass:a = _swig_property(_fitz.Matrix_a_get, _fitz.Matrix_a_set)
    __swig_setmethods__["b"] = _fitz.Matrix_b_set
    __swig_getmethods__["b"] = _fitz.Matrix_b_get
    if _newclass:b = _swig_property(_fitz.Matrix_b_get, _fitz.Matrix_b_set)
    __swig_setmethods__["c"] = _fitz.Matrix_c_set
    __swig_getmethods__["c"] = _fitz.Matrix_c_get
    if _newclass:c = _swig_property(_fitz.Matrix_c_get, _fitz.Matrix_c_set)
    __swig_setmethods__["d"] = _fitz.Matrix_d_set
    __swig_getmethods__["d"] = _fitz.Matrix_d_get
    if _newclass:d = _swig_property(_fitz.Matrix_d_get, _fitz.Matrix_d_set)
    __swig_setmethods__["e"] = _fitz.Matrix_e_set
    __swig_getmethods__["e"] = _fitz.Matrix_e_get
    if _newclass:e = _swig_property(_fitz.Matrix_e_get, _fitz.Matrix_e_set)
    __swig_setmethods__["f"] = _fitz.Matrix_f_set
    __swig_getmethods__["f"] = _fitz.Matrix_f_get
    if _newclass:f = _swig_property(_fitz.Matrix_f_get, _fitz.Matrix_f_set)
    ...
    def invert(self, *args):
        """invert(self, m) -> int"""
        return _fitz.Matrix_invert(self, *args)

    def preTranslate(self, *args):
        """preTranslate(self, sx, sy) -> Matrix"""
        return _fitz.Matrix_preTranslate(self, *args)

    def concat(self, *args):
        """concat(self, m1, m2) -> Matrix"""
        return _fitz.Matrix_concat(self, *args)
...
class Outline(_object):
    ...
    if _newclass:title = _swig_property(_fitz.Outline_title_get)
    __swig_getmethods__["page"] = _fitz.Outline_page_get
    if _newclass:page = _swig_property(_fitz.Outline_page_get)
    __swig_getmethods__["next"] = _fitz.Outline_next_get
    if _newclass:next = _swig_property(_fitz.Outline_next_get)
    __swig_getmethods__["down"] = _fitz.Outline_down_get
    if _newclass:down = _swig_property(_fitz.Outline_down_get)
    __swig_getmethods__["is_open"] = _fitz.Outline_is_open_get
    if _newclass:is_open = _swig_property(_fitz.Outline_is_open_get)
    def saveXML(self, *args):
        ...
        return _fitz.Outline_saveXML(self, *args)
    ...
    def saveText(self, *args):
        ...
        return _fitz.Outline_saveText(self, *args)
...
def _fz_transform_point(*args):
  """_fz_transform_point(point, transform) -> Point"""
  return _fitz._fz_transform_point(*args)
class Point(_object):
    ...
    if _newclass:x = _swig_property(_fitz.Point_x_get, _fitz.Point_x_set)
    __swig_setmethods__["y"] = _fitz.Point_y_set
    __swig_getmethods__["y"] = _fitz.Point_y_get
    if _newclass:y = _swig_property(_fitz.Point_y_get, _fitz.Point_y_set)
...
class Annot(_object):
    ...
    def _setAP(self, *args):
        """_setAP: updates operator source of the /AP"""
        CheckParent(self)

        return _fitz.Annot__setAP(self, *args)

    def setRect(self, *args):
        """setRect: changes the annot's rectangle"""
        CheckParent(self)

        return _fitz.Annot_setRect(self, *args)
    ...
    def setColors(self, *args):
        ...
        return _fitz.Annot_setColors(self, *args)
    ...
    def setLineEnds(self, *args):
        """setLineEnds(self, start, end)"""
        CheckParent(self)

        return _fitz.Annot_setLineEnds(self, *args)
    ...
    def fileUpd(self, *args):
        """Update annotation attached file content."""
        CheckParent(self)

        return _fitz.Annot_fileUpd(self, *args)
    ...
    def setInfo(self, *args):
        ...
        return _fitz.Annot_setInfo(self, *args)
    ...
    def setBorder(self, *args):
        ...
        return _fitz.Annot_setBorder(self, *args)
    ...
    def setFlags(self, *args):
        ...
        return _fitz.Annot_setFlags(self, *args)
...
class DisplayList(_object):
    ...
    def __init__(self, *args):
        ...
        this = _fitz.new_DisplayList(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def run(self, *args):
        ...
        return _fitz.DisplayList_run(self, *args)
    ...
    def getTextPage(self, *args):
        ...
        return _fitz.DisplayList_getTextPage(self, *args)
...
class TextPage(_object):
    ...
    if _newclass:len = _swig_property(_fitz.TextPage_len_get, _fitz.TextPage_len_set)
    def __init__(self, *args):
        """__init__(self, mediabox) -> TextPage"""
        this = _fitz.new_TextPage(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def search(self, *args):
        ...
        return _fitz.TextPage_search(self, *args)
