...
SWIGINTERN struct fz_page_s *fz_document_s_loadPage(struct fz_document_s *self,int number){
            ...
            fz_try(gctx)
            {
                ...
                if (pageCount < 1) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "document has no pages")
/*@SWIG@*/;
                int n = number;
...
SWIGINTERN int fz_document_s_embeddedFileDel(struct fz_document_s *self,char *name){
            ...
            fz_try(gctx)
            {
                /*@SWIG:fitz.i,45,assert_PDF@*/
if (!pdf) /*@SWIG:fitz.i,39,THROWMSG@*/
...
/*@SWIG@*/;
                ...
                if (!efiles) /*@SWIG:fitz.i,39,THROWMSG@*/
...
/*@SWIG@*/;
                ...
                if (strcmp(tname, name) != 0) /*@SWIG:fitz.i,39,THROWMSG@*/
...
/*@SWIG@*/;
                ...
                if (count < 1) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0002)
/*@SWIG@*/;
...
/*@SWIG@*/;
                ...
                if ((!f) && (!d)) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "nothing to change")
/*@SWIG@*/;
...
SWIGINTERN int fz_document_s_embeddedFileAdd(struct fz_document_s *self,PyObject *buffer,char *name,PyObject *filename,PyObject *desc){
            ...
            fz_try(gctx)
            {
                ...
                if (name_len < 1) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0008)
/*@SWIG@*/;
                f = getPDFstr(gctx, filename, &file_len, "filename");
                d = getPDFstr(gctx, desc, &desc_len, "desc");
...
/*@SWIG@*/
/*@SWIG@*/;       // must be PDF
                if (size == 0) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "arg 1 not bytes or bytearray")
/*@SWIG@*/;
                int count = pdf_count_portfolio_entries(gctx, pdf);
                int i;
                char *tname;
                ...
                for (i = 0; i < count; i++)      // check if name already exists
                {
                    ...
                    if (strcmp(tname, name)==0) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "name already exists")
/*@SWIG@*/;
                }
...
/*@SWIG@*/
/*@SWIG@*/;
                if (fz_count_pages(gctx, self) < 1) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "document has zero pages")
/*@SWIG@*/;
                if ((incremental) && (garbage))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "incremental excludes garbage")
/*@SWIG@*/;
                if ((incremental) && (pdf->repair_attempted))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "repaired file - save to new")
/*@SWIG@*/;
                if ((incremental) && (fz_needs_password(gctx, self)))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "encrypted file - save to new")
/*@SWIG@*/;
                if ((incremental) && (linear))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "incremental excludes linear")
/*@SWIG@*/;
...
SWIGINTERN int fz_document_s_insertPDF(struct fz_document_s *self,struct fz_document_s *docsrc,int from_page,int to_page,int start_at,int rotate,int links){
            ...
            fz_try(gctx)
            {
                if (!pdfout || !pdfsrc) /*@SWIG:fitz.i,39,THROWMSG@*/
...
/*@SWIG@*/
/*@SWIG@*/;
                if (pno < -1) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0003)
/*@SWIG@*/;
...
/*@SWIG@*/;
                ...
                if ((t == pno) || (pno == t - 1))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "source and target too close")
/*@SWIG@*/;
                pdf_obj *page = pdf_lookup_page_obj(gctx, pdf, pno);
...
/*@SWIG@*/;
                        ...
                        /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "page numbers must be integers")
/*@SWIG@*/;
                }
            }
            fz_catch(gctx)
...
/*@SWIG@*/;
                if (fontname && fontfile || fontname && xref || fontfile && xref)
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "need exactly one of fontfile, fontname, xref")
/*@SWIG@*/;
                if (fontname)
                {
                    data = fz_lookup_base14_font(gctx, fontname, &size);
                    if (!data) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "unknown PDF Base 14 font")
/*@SWIG@*/;
                            ...
                            if (pdf_is_dict(gctx, o))
                            {
                                ...
                                if (pdf_is_name(gctx, basefont))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (!buf) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "xref not a font, or not supported")
/*@SWIG@*/;
...
/*@SWIG@*/;
                ...
                if (!valid_font) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "invalid font: widths = 0 up to 0xff")
/*@SWIG@*/;
            }
            fz_always(gctx)
            {
...
SWIGINTERN PyObject *fz_document_s__getPageObjNumber(struct fz_document_s *self,int pno){
            ...
            fz_try(gctx)
            {
                if (pno >= pageCount) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0003)
/*@SWIG@*/;
                /*@SWIG:fitz.i,45,assert_PDF@*/
if (!pdf) /*@SWIG:fitz.i,39,THROWMSG@*/
...
SWIGINTERN PyObject *fz_document_s_getPageImageList(struct fz_document_s *self,int pno){
            ...
            fz_try(gctx)
            {
                if (n >= pageCount) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0003)
/*@SWIG@*/;
                /*@SWIG:fitz.i,45,assert_PDF@*/
if (!pdf) /*@SWIG:fitz.i,39,THROWMSG@*/
...
SWIGINTERN int fz_document_s__getOLRootNumber(struct fz_document_s *self){
            pdf_document *pdf = pdf_specifics(gctx, self);
            fz_try(gctx) /*@SWIG:fitz.i,45,assert_PDF@*/
if (!pdf) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0001)
/*@SWIG@*/
/*@SWIG@*/;
...
/*@SWIG@*/;
                ...
                if (!root) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "could not load root object")
/*@SWIG@*/;
...
/*@SWIG@*/;
                ...
                if (c == NULL) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "invalid stream")
/*@SWIG@*/;
                // get the object
                obj = pdf_new_indirect(gctx, pdf, xref, 0);
                if (!obj) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "xref invalid")
/*@SWIG@*/;
                if (!pdf_is_stream(gctx, obj)) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "object not a stream")
/*@SWIG@*/;
...
SWIGINTERN int fz_page_s_setRotation(struct fz_page_s *self,int rot){
            fz_try(gctx)
            {
                pdf_page *page = pdf_page_from_fz_page(gctx, self);
                /*@SWIG:fitz.i,45,assert_PDF@*/
if (!page) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0001)
/*@SWIG@*/
/*@SWIG@*/;
                if (rot % 90) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "rotate not multiple of 90")
/*@SWIG@*/;
...
/*@SWIG@*/;
                ...
                if ((pixmap) && (filename) || (!pixmap) && (!filename))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "need exactly one of filename, pixmap")
/*@SWIG@*/;
                if (!fz_contains_rect(&prect, rect))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "rect not contained in page rect")
/*@SWIG@*/;
                if (fz_is_empty_rect(rect) || fz_is_infinite_rect(rect))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "rect must be finite and not empty")
/*@SWIG@*/;
                ...
                if (!res) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "bad PDF: Contents is no stream object")
/*@SWIG@*/;
...
SWIGINTERN int fz_page_s_insertFont(struct fz_page_s *self,char const *fontname,char const *fontfile){
            pdf_page *page = pdf_page_from_fz_page(gctx, self);
            pdf_document *pdf;
...
/*@SWIG@*/;
                pdf = page->doc;
                if (!fontname) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "need fontname")
/*@SWIG@*/;
                ...
                {
                    if (!fontfile) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "unknown PDF Base 14 font")
/*@SWIG@*/;
                    font = fz_new_font_from_file(gctx, NULL, fontfile, 0, 0);
                }
...
SWIGINTERN struct fz_rect_s *new_fz_rect_s__SWIG_6(PyObject *list){
            ...
            fz_try(gctx)
            {
                if (!PySequence_Check(list)) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0005)
/*@SWIG@*/;
                if (PySequence_Size(list) != 4) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0010)
/*@SWIG@*/;
...
SWIGINTERN struct fz_pixmap_s *new_fz_pixmap_s__SWIG_2(struct fz_pixmap_s *spix){
            struct fz_pixmap_s *pm = NULL;
            int n, w, h, balen, i, j, l;
            fz_try(gctx)
            {
                if (spix->alpha == 1) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "source pixmap already has alpha")
/*@SWIG@*/;
...
SWIGINTERN struct fz_pixmap_s *new_fz_pixmap_s__SWIG_3(struct fz_colorspace_s *cs,int w,int h,PyObject *samples,int alpha){
            char *data = NULL;
            size_t size = 0;
...
/*@SWIG@*/;
                if (stride * h != size) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "len(samples) invalid")
/*@SWIG@*/;
...
SWIGINTERN struct fz_pixmap_s *new_fz_pixmap_s__SWIG_4(char *filename){
            struct fz_image_s *img = NULL;
            struct fz_pixmap_s *pm = NULL;
            fz_try(gctx) {
                if (!filename) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0011)
/*@SWIG@*/;
...
SWIGINTERN struct fz_pixmap_s *new_fz_pixmap_s__SWIG_5(PyObject *imagedata){
            size_t size = 0;
            fz_buffer *data = NULL;
            struct fz_image_s *img = NULL;
            struct fz_pixmap_s *pm = NULL;
            fz_try(gctx)
            {
                if (!imagedata) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0011)
/*@SWIG@*/;
...
SWIGINTERN struct fz_pixmap_s *new_fz_pixmap_s__SWIG_6(struct fz_document_s *doc,int xref){
            struct fz_image_s *img = NULL;
...
/*@SWIG@*/;
                ...
                if (!pdf_name_eq(gctx, type, PDF_NAME_Image))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "xref not an image")
/*@SWIG@*/;
...
SWIGINTERN int fz_pixmap_s_setAlpha(struct fz_pixmap_s *self,PyObject *alphavalues){
            fz_try(gctx)
            {
                if (self->alpha == 0) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "pixmap has no alpha channel")
/*@SWIG@*/;
                ...
                if (alphavalues)
                {
                    ...
                    if (data_len > 0 && data_len < w * h)
                        /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "too few alpha values")
/*@SWIG@*/;
                }
                int i = 0, k = 0;
                while (i < balen)
...
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0005)
/*@SWIG@*/;
                if (PySequence_Size(list) != 6) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0010)
/*@SWIG@*/;
...
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0005)
/*@SWIG@*/;
                if (PySequence_Size(list) != 2) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0010)
/*@SWIG@*/;
...
SWIGINTERN PyObject *fz_annot_s__getAP(struct fz_annot_s *self){
            ...
            {
                /*@SWIG:fitz.i,45,assert_PDF@*/
if (!annot) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", msg0001)
/*@SWIG@*/
/*@SWIG@*/;
                if (!annot->ap) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "annot has no /AP")
/*@SWIG@*/;
...
/*@SWIG@*/;
                ...
                if (type != 16)
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "not a file attachment annot")
/*@SWIG@*/;
                stream = pdf_dict_getl(gctx, annot->obj, PDF_NAME_FS,
                                   PDF_NAME_EF, PDF_NAME_F, NULL);
                if (!stream) /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "bad PDF: file has no stream")
/*@SWIG@*/;
            }
            fz_catch(gctx) return NULL;
...
/*@SWIG@*/;
                if (!PyDict_Check(info))
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "info not a dict")
/*@SWIG@*/;
                if (!dictvalid)
                    /*@SWIG:fitz.i,39,THROWMSG@*/
fz_throw(gctx, FZ_ERROR_GENERIC,"%s", "invalid key in info dict")
/*@SWIG@*/;
...
SWIGINTERN PyObject *_wrap_Page_insertFont(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O|OO:Page_insertFont",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    result = (int)fz_page_s_insertFont(arg1,(char const *)arg2,(char const *)arg3);
    if(result<0)
    {
      PyErr_SetString(PyExc_Exception, gctx->error->message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_new_Pixmap__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    result = (struct fz_pixmap_s *)new_fz_pixmap_s__SWIG_3(arg1,arg2,arg3,arg4,arg5);
    if(!result)
    {
      PyErr_SetString(PyExc_Exception, gctx->error->message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_new_Pixmap__SWIG_6(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg2 = (int)(val2);
  {
    result = (struct fz_pixmap_s *)new_fz_pixmap_s__SWIG_6(arg1,arg2);
    if(!result)
    {
      PyErr_SetString(PyExc_Exception, gctx->error->message);
      return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Document_save", _wrap_Document_save, METH_VARARGS, (char *)"\n"
		"Document_save(self, filename, garbage=0, clean=0, deflate=0, incremental=0, ascii=0, expand=0, \n"
		"    linear=0) -> int\n"
		""},
	 ...
	 { (char *)"Page_insertFont", _wrap_Page_insertFont, METH_VARARGS, (char *)"Page_insertFont(self, fontname=None, fontfile=None) -> int"},
